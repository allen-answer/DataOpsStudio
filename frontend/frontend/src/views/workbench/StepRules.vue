...
// 4 个对比规则开关 —— 表头：rule key、label、说明
const RULE_TOGGLES = [
  ...
  { key: 'stream_compare',  label: '流式分块对比',   hint: '不全量加载内存，要求两侧 SQL 已按主键排序' },
]
</script>
    ...
    <div class="card">
      ...
      <div class="grid grid-cols-1 gap-2 md:grid-cols-2">
        <label
          ...
          class="flex cursor-pointer items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3 transition hover:border-primary/50 hover:bg-white"
        >
          <input
